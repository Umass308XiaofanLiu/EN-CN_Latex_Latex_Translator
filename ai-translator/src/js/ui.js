...
function renderSettingsModal() {
    ...
    const onlineModels = [
        ...
        { id: 'gpt-5.3-codex-spark', name: 'GPT-5.3 Codex Spark', provider: 'openai', iconClass: 'text-yellow-500' },
...
function renderModelSelector() {
    ...
    const allOpenaiModels = [
        ...
        { id: 'gpt-5.3-codex-spark', name: 'GPT-5.3 Codex Spark', sub: 'Real-Time Coding (1000 tok/s)', iconClass: 'text-yellow-500', icon: Icons.Zap }
    ];
    ...
    if (AppState.apiProvider === 'local') {
        ...
        currentLabel = AppState.selectedModel === 'gpt-5-nano' ? 'GPT-5 Nano' :
                       AppState.selectedModel === 'gpt-5-mini' ? 'GPT-5 Mini' :
                       AppState.selectedModel === 'gpt-5.3-codex-spark' ? 'Codex Spark' : 'GPT-5.2';
